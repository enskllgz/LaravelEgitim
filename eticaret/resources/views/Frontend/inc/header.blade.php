        ...
        <ul class="site-menu js-clone-nav d-none d-md-block">
         <li class="active"><a href="{{route('anasayfa')}}">Anasayfa</a></li>
          <li class="has-children">
            <a href="#">Kategori</a>
            <ul class="dropdown">
               {{-- @if (!empty($allcategories) && $categories->count() > 0)
                ...
                <ul class="dropdown">
                    <li><a href='urunler'>Kazaklar</a></li>
                    <li><a href='urunler'>Pantolonlar</a></li>
                </ul>
                </li> 
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                      <li><a href='urunler'>Kazaklar</a></li>
                      <li><a href='urunler'>Pantolonlar</a></li>
                      <li><a href='urunler'>Çantalar</a></li>
                  </ul>
                  </li> 
                  ...
                  <li class="has-children">
                    ...
                    <ul class="dropdown">
                        <li><a href='urunler'>Kazaklar</a></li>
                        <li><a href='urunler'>Pantolonlar</a></li>
                        <li><a href='urunler'>Oyuncaklar</a></li>
                    </ul>
                    </li> 
            </ul>
          </li>
